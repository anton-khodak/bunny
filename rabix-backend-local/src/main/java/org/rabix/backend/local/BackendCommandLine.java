...
public class BackendCommandLine {
    ...
    public static void main(String[] commandLineArguments) {
        try {
            BackendCommandLineParser clParser = new BackendCommandLineParser(configDir, commandLineArguments);
            final ConfigModule configModule = new ConfigModule(clParser.getConfigDir(), clParser.getConfigOverrides());
            Injector injector = Guice.createInjector(
                    ...
                    new AbstractModule() {
                        ...
                        protected void configure() {
                            ...
                            bind(StorageConfiguration.class).toInstance(new LocalStorageConfiguration(clParser.getAppPath(), configModule.provideConfig()));
            ...
            // Load app from JSON
            AppLoader appLoader = new AppLoader(clParser.getAppUrl(), clParser.getInputsFile(), clParser.getCommandLineArray(),
                    clParser.getInputArguments(), clParser.getCommandLineParser());
            ...
            final Job job = jobService.start(new Job(clParser.getAppUrl(), (Map<String, Object>) commonInputs), contextConfig);
